...
var numberofPages = 0;
// Set the ufoData to data intially
var filteredData = ufoData;

// Function to get the total nummber of Pages based on the resultsPerPage
...
function renderTable(ufoData){
  ...
  if(ufoData.length>0){
    for(var i=0;i<ufoData.length;i++){
      var fields=Object.keys(ufoData[i]);
      var $row = $tbody.insertRow();
      var rowdata = ufoData[i];
